            ...
            >
              ...
              >
                ...
                <div className="relative h-40 w-20">
                  ...
                  {/* Body - smoother shape */}
                  <div className="absolute left-3 top-8 h-16 w-12 rounded-md bg-destructive"></div>

                  {/* Arms - better positioning */}
                  <div className="absolute left-0 top-12 h-4 w-8 rounded-full bg-destructive transform -rotate-12"></div>
                  <div className="absolute left-11 top-13 h-4 w-8 rounded-full bg-destructive transform rotate-12"></div>
