            ...
            >
              ...
              >
                ...
                <div className="relative h-48 w-24">
                  ...
                  {/* Body */}
                  <div className="absolute left-4 top-10 h-20 w-16 rounded-md bg-destructive"></div>
                  
                  {/* Arms */}
                  <div className="absolute left-0 top-14 h-6 w-10 rounded-full bg-destructive"></div>
                  <div className="absolute left-14 top-16 h-6 w-10 rounded-full bg-destructive"></div>
